import java.util.*;
/**
 * Handman manager is the primary program for a game of hangman that cheats by always leaving the player with the widest possible
 * set of answers when a letter is guessed.
 */
